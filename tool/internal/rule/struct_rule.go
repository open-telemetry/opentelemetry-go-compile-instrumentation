...
type InstStructField struct {
	Name string `json:"name" yaml:"name" jsonschema:"minLength=1"` // The name of the field to be added
	Type string `json:"type" yaml:"type" jsonschema:"minLength=1"` // The type of the field to be added
}
...
type InstStructRule struct {
	...
	Struct   string             `json:"struct"    yaml:"struct"    jsonschema:"minLength=1"` // The type name of the struct to be instrumented
