...
// github.com/openai/openai-go/v2. The hooks inject
...
// subpackage — this file is a thin adapter that bridges v2's
...
import (
	...
	middleware "github.com/open-telemetry/opentelemetry-go-compile-instrumentation/pkg/instrumentation/openai/v2/internal/middleware"
)
...
func withOtelMiddleware(opts []option.RequestOption) []option.RequestOption {
	// option.Middleware in v2 is a type alias to
