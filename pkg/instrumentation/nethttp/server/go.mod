...
require (
	github.com/open-telemetry/opentelemetry-go-compile-instrumentation/pkg v0.0.0-20260206063050-522db1657ebc
	github.com/open-telemetry/opentelemetry-go-compile-instrumentation/pkg/instrumentation/nethttp/client v0.0.0-20260206063050-522db1657ebc
	github.com/open-telemetry/opentelemetry-go-compile-instrumentation/pkg/instrumentation/shared v0.0.0-20260206063050-522db1657ebc
