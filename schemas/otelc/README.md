...
| `log`, `log/slog`, `github.com/sirupsen/logrus`, `go.uber.org/zap`, `github.com/rs/zerolog` | `logs.yaml`          | nothing — injects `trace_id`/`span_id` into the application's own logs |
