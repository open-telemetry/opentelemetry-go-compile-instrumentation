...
require (
	...
	github.com/open-telemetry/opentelemetry-go-compile-instrumentation/instrumentation/github.com/sirupsen/logrus v0.0.0-00010101000000-000000000000
	github.com/open-telemetry/opentelemetry-go-compile-instrumentation/instrumentation/go.opentelemetry.io/otel/hook v0.0.0-20260625124055-4615b40860db
	github.com/open-telemetry/opentelemetry-go-compile-instrumentation/instrumentation/log v0.0.0-20260625124055-4615b40860db
	github.com/open-telemetry/opentelemetry-go-compile-instrumentation/instrumentation/log/slog v0.0.0-20260625124055-4615b40860db
	github.com/open-telemetry/opentelemetry-go-compile-instrumentation/instrumentation/net/http/client v0.0.0-20260625124055-4615b40860db
	github.com/open-telemetry/opentelemetry-go-compile-instrumentation/instrumentation/net/http/server v0.0.0-20260625124055-4615b40860db
