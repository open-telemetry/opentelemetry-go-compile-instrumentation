...
replace github.com/open-telemetry/opentelemetry-go-compile-instrumentation/instrumentation => D:\opentelemetry-go-compile-instrumentation\test\apps\httpserver\.otelc-build\instrumentation

replace github.com/open-telemetry/opentelemetry-go-compile-instrumentation/instrumentation/net/http/client => D:\opentelemetry-go-compile-instrumentation\test\apps\httpserver\.otelc-build\instrumentation\net\http\client

replace github.com/open-telemetry/opentelemetry-go-compile-instrumentation/instrumentation/net/http/server => D:\opentelemetry-go-compile-instrumentation\test\apps\httpserver\.otelc-build\instrumentation\net\http\server

replace github.com/open-telemetry/opentelemetry-go-compile-instrumentation/instrumentation/runtime => D:\opentelemetry-go-compile-instrumentation\test\apps\httpserver\.otelc-build\instrumentation\runtime

replace github.com/open-telemetry/opentelemetry-go-compile-instrumentation/pkg => D:\opentelemetry-go-compile-instrumentation\test\apps\httpserver\.otelc-build\pkg

replace github.com/open-telemetry/opentelemetry-go-compile-instrumentation/pkg/runtime => D:\opentelemetry-go-compile-instrumentation\test\apps\httpserver\.otelc-build\pkg\runtime
