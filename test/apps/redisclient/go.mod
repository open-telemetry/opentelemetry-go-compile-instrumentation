...
replace github.com/open-telemetry/opentelemetry-go-compile-instrumentation/instrumentation/github.com/redis/go-redis/v9 => ../../../instrumentation/github.com/redis/go-redis/v9
