...
func parseAstFromFile(filePath string) *dst.File {
...
func saveAstToFile(filePath string, ast *dst.File) {
...
func newTrampoline() *dst.FuncDecl {
	trampoline := &dst.FuncDecl{
		...
		Type: &dst.FuncType{},
		Body: &dst.BlockStmt{
			List: []dst.Stmt{newFuncCall("Hook")},
		},
	}
	return trampoline
}
